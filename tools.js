...
// Extrae automáticamente todas las claves de 'properties' para el array 'required'
...
export const toolsSchema = [
  ...
  tool('glob', 'Busca archivos con patrones, incluyendo ** y *.', {
    pattern: stringProperty('Patrón'),
    search_dir: stringProperty('Directorio base'),
    max_results: { type: 'integer' },
  }),
  tool('grep', 'Busca texto o expresiones regulares.', {
    query: stringProperty('Texto o expresión regular'),
    search_dir: stringProperty('Directorio'),
    file_pattern: stringProperty('Filtro'),
    max_results: { type: 'integer' },
  ...
  tool('update_file', 'Modifica un archivo.', {
    path: stringProperty('Ruta'),
    old_string: stringProperty('Texto original'),
    new_string: stringProperty('Texto nuevo'),
  }),
  tool('write_file', 'Crea o sobrescribe un archivo.', {
    path: stringProperty('Ruta'),
    content: stringProperty('Contenido'),
  }),
  tool('run_command', 'Ejecuta un comando no interactivo.', {
    command: stringProperty('Ejecutable'),
    args: { type: 'array', items: { type: 'string' } },
    timeout: { type: 'integer' },
  }),
  tool('git_status', 'Muestra el estado de Git.', {}),
  tool('git_diff', 'Muestra cambios de Git.', {
    staged: { type: 'boolean' },
  }),
  tool('git_log', 'Muestra commits recientes.', {
    limit: { type: 'integer' },
  }),
  tool('git_commit', 'Crea un commit de cambios rastreados.', {
    message: stringProperty('Mensaje'),
  }),
  tool('git_branch', 'Crea y cambia a una rama nueva.', {
    name: stringProperty('Nombre'),
  }),
];
